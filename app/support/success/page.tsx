                ...
                <CardContent className="pt-12 pb-10 text-center">
                  ...
                  >
                    ...
                    <p className="text-muted-foreground max-w-md mx-auto">
                      Dukungan Anda sangat berarti untuk pengembangan BagiBerkah. 
                      Kami akan terus berinovasi dan menghadirkan fitur terbaik untuk Anda.
                    </p>
                  </motion.div>
                  ...
                  >
                    ...
                    <div className="flex gap-2 justify-center">
                      <Button
                        ...
                        size="sm"
                        onClick={() => {
                          const text = "Saya baru saja mendukung BagiBerkah! Platform AI untuk berbagi THR yang lebih bermakna. Coba sekarang di bagiberkah.com";
